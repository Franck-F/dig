 ...
 *
 * Same layout as the verification-code email. Different subject + body
 * copy so users can distinguish the two flows in their inbox.
 */
...
export function passwordResetEmail({
  ...
  void _locale;
  const subject = 'Réinitialisation de ton mot de passe Digizelle';
  ...
  const text = [
    ...
    '',
    'Saisis-le dans la fenêtre Digizelle pour choisir un nouveau mot de passe.',
    ...
    <table role="presentation" width="560" cellpadding="0" cellspacing="0" border="0" style="max-width:560px;width:100%;background:#ffffff;border-radius:20px;overflow:hidden;box-shadow:0 12px 40px rgba(115,1,255,0.12);">
      <tr>
        <td style="background:linear-gradient(135deg,#7301FF 0%,#A34BF5 50%,#F46FB1 100%);padding:36px 32px;text-align:center;color:#ffffff;">
          ...
          <div style="font-size:24px;font-weight:700;margin-top:6px;">Réinitialise ton mot de passe</div>
        </td>
      </tr>
      <tr>
        <td style="padding:32px;">
          <p style="margin:0 0 16px;font-size:16px;line-height:1.5;">Tu as demandé à réinitialiser ton mot de passe.</p>
          <p style="margin:0 0 24px;font-size:15px;line-height:1.6;color:#3a3a5a;">Saisis ce code dans la fenêtre Digizelle pour en choisir un nouveau&nbsp;:</p>
          ...
          <p style="margin:24px 0 0;font-size:13px;color:#6b6b8a;line-height:1.5;">Si tu n'es pas à l'origine de cette demande, ignore cet email — ton mot de passe actuel reste valide.</p>
        </td>
      </tr>
      <tr>
